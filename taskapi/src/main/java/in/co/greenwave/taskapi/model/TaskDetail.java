...
//	public TaskDetail(String creationTime, String taskName, String taskId, String status, String reviewer,
//			String remarks, String description, String creator, String hourMinutes, List<ActivityDetails> activityList,
//			String actFile, List<String> userGroupsList, List<String> userDeptsList, String assetGroup,
//			int statusTransition, int noOfActivites) {
//		super();
...
//	}
	...
	public TaskDetail(String creationTime, String taskName, String taskId, String status, String reviewer,
			String remarks, String description, String creator, String hourMinutes, List<ActivityDetails> activityList,
			String actFile, List<String> userGroupsList, List<String> userDeptsList, String assetGroup,
			int statusTransition, int noOfActivites, boolean adhocTask) {
		super();
		this.creationTime = creationTime;
		this.taskName = taskName;
		this.taskId = taskId;
...
//	}
	...
	public String toString() {
		return "TaskDetail [creationTime=" + creationTime + ", taskName=" + taskName + ", taskId=" + taskId
				...
				+ activityList + ", actFile=" + actFile + ", userGroupsList=" + userGroupsList + ", userDeptsList="
				+ userDeptsList + ", assetGroup=" + assetGroup + ", statusTransition=" + statusTransition
				+ ", noOfActivites=" + noOfActivites + ", adhocTask=" + adhocTask + "]";
	}
