//package in.co.greenwave.config;
//
//
//
...
//	/**
//	 * 
//	 * @return a @Bean of DataSource of MS SQL server configuration
//	 */
//	@Bean
//	@Primary
...
//	/**
//	 * 
//	 * @return a @Bean of @JdbcTemplate configured for SQL server
//	 */
//	@Bean
//	@Qualifier(value = "sql-server")
