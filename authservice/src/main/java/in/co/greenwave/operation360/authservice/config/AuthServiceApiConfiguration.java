package in.co.greenwave.operation360.authservice.config; // Declares the package where the configuration resides
...
import in.co.greenwave.operation360.authservice.repository.factory.PostgresDAOFactory;
import in.co.greenwave.operation360.authservice.repository.factory.SQLServerDAOFactory;
...
public class AuthServiceApiConfiguration {
