...
public class JwtService {
    ...
    private String createToken(Map<String, Object> claims, String userName) {
        return Jwts.builder() // We start building our token
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 120)) // We set the expiration date (30 minutes from now)
    ...
    public String extendTokenExpiration(String token) {
        ...
        Date newExpirationDate = new Date(System.currentTimeMillis() + (1000 * 60 * 120)); // We set a new expiration date (30 minutes from now)
        Map<String, Object> claims = new HashMap<>(); // We create a new map for claims
