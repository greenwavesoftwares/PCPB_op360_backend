...
public class ActivityDetails implements Serializable{
	...
	// Name of the job associated with this task
	...
	private boolean enableActivityPerformance;
...
//	}
	...
	//constructor with activity status
		...
		public ActivityDetails(String taskId, String taskName, String jobId, String jobName, String activityId,
				String activityName, int sequence, String logbook, int duration, String xPos, String yPos, String performer,
				String approver, Date scheduledActivityStartTime, Date scheduledActivityEndTime,
				Date actualActivityStartTime, Date actualActivityEndTime, boolean notBelongToPerformer,
				boolean notBelongToApprover, String actvityStatus, boolean isActvityBtnDisableOnCompletion,
				boolean isActvityBtnDisbleForActvtOrder, String actAbrv, boolean available,
				List<PerformerAvailability> performerAvlReasons, boolean assetAvailable,
				List<PerformerAvailability> assetAvlReasons, String actualActvtyStrt, String actualActvtEnd,
				Date reviewerActivityStartTime, Date reviewerActivityStopTime, String remarks, String assetId,
				String assetName, List<String> assetIDList, List<String> assetNameList, boolean groupOrDept,
				String groupOrDeptName, String performerType, List<User> getGroupOrDeptWisePerformer, int completedActivity,
				int pendingActivity, int rejectedActivity, String date, int actvtCount, String actFile,
				byte[] activityFileData, boolean enforceStart, Integer weekdays, int buffer, String delayDueToBuffer,
				boolean enforce, boolean booleanForActivityStatus, boolean disable, boolean disableForAction,
				List<String> selectedAssetList, List<String> selectedAssetIdsList, boolean enableStart) {
			super();
			this.taskId = taskId;
			this.taskName = taskName;
			this.jobId = jobId;
	...
	public boolean isEnableActivityPerformance() {
		return enableActivityPerformance;
	}

	public void setEnableActivityPerformance(boolean enableActivityPerformance) {
		this.enableActivityPerformance = enableActivityPerformance;
	}

	@Override
	public String toString() {
		return "ActivityDetails [taskId=" + taskId + ", taskName=" + taskName + ", jobId=" + jobId + ", jobName="
				+ jobName + ", activityId=" + activityId + ", activityName=" + activityName + ", sequence=" + sequence
				+ ", logbook=" + logbook + ", duration=" + duration + ", xPos=" + xPos + ", yPos=" + yPos
				+ ", performer=" + performer + ", approver=" + approver + ", scheduledActivityStartTime="
				+ scheduledActivityStartTime + ", scheduledActivityEndTime=" + scheduledActivityEndTime
				+ ", actualActivityStartTime=" + actualActivityStartTime + ", actualActivityEndTime="
				+ actualActivityEndTime + ", notBelongToPerformer=" + notBelongToPerformer + ", notBelongToApprover="
				+ notBelongToApprover + ", actvityStatus=" + actvityStatus + ", isActvityBtnDisableOnCompletion="
				...
				+ ", actFile=" + actFile + ", activityFileData=" + Arrays.toString(activityFileData) + ", enforceStart="
				+ enforceStart + ", weekdays=" + weekdays + ", buffer=" + buffer + ", delayDueToBuffer="
				+ delayDueToBuffer + ", enforce=" + enforce + ", booleanForActivityStatus=" + booleanForActivityStatus
				+ ", disable=" + disable + ", disableForAction=" + disableForAction + ", selectedAssetList="
				+ selectedAssetList + ", selectedAssetIdsList=" + selectedAssetIdsList + ", enableStart=" + enableStart
				+ ", enableActivityPerformance=" + enableActivityPerformance
				+ "]";
	}
