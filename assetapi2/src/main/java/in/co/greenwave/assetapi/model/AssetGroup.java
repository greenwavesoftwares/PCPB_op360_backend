...
import java.util.List; // To use lists of items
import java.util.Map; // To use pairs of keys and values
...
// This class represents a group of assets
...
public class AssetGroup {
    ...
    private Map<AssetModel, List<AssetModel>> assetInfo; // A map that links each asset model to a list of related asset models
    ...
    public AssetGroup(String groupName, String groupId, String createdBy, String createdOn) {
    ...
    public AssetGroup(String groupName, String groupId) {
        super(); // Calls the parent class constructor
        this.groupName = groupName; // Sets the group name
        this.groupId = groupId;     // Sets the group ID
    }
    ...
    public AssetGroup(String groupName, String groupId, String createdBy, String createdOn,
                      Map<AssetModel, List<AssetModel>> assetInfo, String assetMapImage) {
        super(); // Calls the parent class constructor
        this.groupName = groupName; // Sets the group name
        this.groupId = groupId; // Sets the group ID
        this.createdBy = createdBy; // Sets who created the group
        this.createdOn = createdOn; // Sets when the group was created
        this.assetInfo = assetInfo; // Sets the asset information
    ...
    public Map<AssetModel, List<AssetModel>> getAssetInfo() {
        return assetInfo; // Returns the asset information
    }

    // Setter method to change asset information
    public void setAssetInfo(Map<AssetModel, List<AssetModel>> assetInfo) {
        this.assetInfo = assetInfo; // Updates the asset information
    }
    ...
    // This method returns a string representation of the AssetGroup object
    @Override
    public String toString() {
        return "AssetGroup [groupName=" + groupName + ", groupId=" + groupId + ", createdBy=" + createdBy
