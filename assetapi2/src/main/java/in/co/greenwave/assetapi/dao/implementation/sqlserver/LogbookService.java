...
public class LogbookService implements LogbookDAO {
    ...
    public List<FormDetails> getAllActiveForms(String tenantId) {
        ...
        String sql = "SELECT Distinct FormId,FormName,VersionNumber,DocumentID,Department,UserGroup,formatID,isActiveForm FROM [dbo].[DigitalLogbookFormInfo] WHERE isActiveForm = 1 AND [TenantId] = ?";
